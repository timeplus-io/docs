...
- Streaming engine
  - Added new function `moving_sum` to calculate the moving sum for a column. This unlocks more use cases of stateful streaming processing, such as [streaming over](https://share.streamlit.io/timeplus-io/github_liveview/develop/stream_over.py).
