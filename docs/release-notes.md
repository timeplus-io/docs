...
*Proton:*
  * You can now install single native binary for Mac - check out our installation guide [here](https://github.com/timeplus-io/proton/wiki/Install-single-binary-Proton).
