...
* For Kubernetes users: helm install timeplus/timeplus-enterprise --version v7.0.40 ..
* For Docker users (not recommended for production): `docker run -p 8000:8000 docker.timeplus.com/timeplus/timeplus-enterprise:2.8.17`
...
#### Changelog {#changelog_2_8_17}
Compared to the [2.8.16](#2_8_16) release:
* timeplusd 2.8.42 -> 2.8.43
  * Bugfixes  
...
* For Kubernetes users: helm install timeplus/timeplus-enterprise --version v7.0.39 ..
...
Compared to the [2.8.10](#2_8_10) release:
* timeplusd 2.8.34 -> 2.8.35
  * Bugfixes  
    *   Fixed cross join issue.
    *   Fixed direct join complex expression issue.
    *   Fixed low_cardinality fields within array issue.
...
* For Kubernetes users: helm install timeplus/timeplus-enterprise --version v7.0.29 ..
* For Docker users (not recommended for production): `docker run -p 8000:8000 docker.timeplus.com/timeplus/timeplus-enterprise:2.8.8`
