...
You can use `data_format='JSONEachRow'`  to inform Proton to write each event as a JSON document. The columns of the external steram will be converted to keys in the JSON documents. For example:
...
You can use `data_format='CSV'`  to inform Proton to write each event as a JSON document. The columns of the external steram will be converted to keys in the JSON documents. For example:
