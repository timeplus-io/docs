...
### v3.2.2 {#3_2_2}
Released on 04-09-2026 ([Change logs](/enterprise-v3.0#3_2_2)).

* Bare metal installation: [Linux x86_64](https://d.timeplus.com/timeplus-enterprise-v3.2.2-linux-amd64.tar.gz) | [Linux ARM64](https://d.timeplus.com/timeplus-enterprise-v3.2.2-linux-arm64.tar.gz) | [macOS x86_64](https://d.timeplus.com/timeplus-enterprise-v3.2.2-darwin-amd64.tar.gz) | [macOS ARM64](https://d.timeplus.com/timeplus-enterprise-v3.2.2-darwin-arm64.tar.gz)
* All-in-one Docker image (not recommended for production): `docker run -p 8000:8000 docker.timeplus.com/timeplus/timeplus-enterprise:3.2.2`
