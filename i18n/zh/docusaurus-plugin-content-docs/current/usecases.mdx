...
| credit_card  | 字符串  | 371712345678910 |
| 两性平等         | 字符串  | F               |
| birthday     | 字符串  | 1990-01-15      |

### dim_car_info

A relative static stream with all registered cars

| Column           | Comment                                                                      | 类型    | 示例值          |
| ---------------- | ---------------------------------------------------------------------------- | ----- | ------------ |
| cid              | car ID                                                                       | 字符串   | c00001       |
| license_plate_no |                                                                              | 字符串   | KM235L       |
| in_service       | False if the car is suspended (retried or in maintenance) | 布尔值   | True         |
...
| Column      | Comment                                                      | 类型      | 示例值                      |
| ----------- | ------------------------------------------------------------ | ------- | ------------------------ |
| 时间          | datetime of the sensor data                                  | 日期时间    | 2022-01-12 23:00:58.476  |
| cid         | Car ID                                                       | 字符串     | c00001                   |
| longitude   | current position                                             | 浮点数     | 40.75896                 |
| latitude    | current position                                             | 浮点数     | \-73.985195              |
| gas_percent | percentage of gas level, 100 means full tank                 | 小数      | 86.12                    |
| speed_kmh   | current driving speed in KM/hour                             | 整数      | 56                       |
| total_km    | this car's total distance in km. Keep increasing after trips | 浮点数     | 3536                     |
| locked      | whether the car is locked                                    | 布尔值     | True                     |
| in_use      | whether someone is using the car                             | 布尔值     | True                     |
...
| Column       | Comment                                                     | 类型     | 示例值                     |
| ------------ | ----------------------------------------------------------- | ------ | ----------------------- |
| 时间           | When the event happens                                      | 日期时间   | 2022-01-12 13:00:58.476 |
| bid          | booking ID                                                  | 字符串    | b00001                  |
| booking_time | When the user books the car. Expire in 30min                | 日期时间   | 2022-01-12 13:30:58.476 |
| uid          | User ID                                                     | 字符串    | u00001                  |
| cid          | Car ID                                                      | 字符串    | c00001                  |
| action       | One of the values: add, cancel, extend, service, expire,end | 字符串    | add                     |
| expire       | When the booking will be expired                            | 日期时间   | 2022-01-12 13:30:58.476 |
...
| Column     | Comment                                   | 类型     | 示例值                      |
| ---------- | ----------------------------------------- | ------ | ------------------------ |
| tid        | Trip ID                                   | 字符串    | t00001                   |
| start_time | When the trip starts                      | 日期时间   | 2022-01-12 13:00:58.476  |
| end_time   | When the trip ends                        | 日期时间   | 2022-01-12 24:00:58.476  |
| bid        | booking ID                                | 字符串    | b00001                   |
| start_lon  | Start location                            | 浮点数    | 40.75896                 |
| start_lat  | Start location                            | 浮点数    | \-73.985195              |
| end_lon    | End location                              | 浮点数    | 42.75896                 |
| end_lat    | End location                              | 浮点数    | \-71.985195              |
| distance   | distance drove in km                      | 浮点数    | 23.2                     |
| 金额         | how much the user should pay for the trip | 小数     | 40.75                    |
...
| data point | 事件时间 Event Time              | arrive time             | 备注                                                                                                                                                                                                                       |
| ---------- | ---------------------------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| ----------------------- | -------------------------------------------------------------------------------------------------------- |
| 2022-01-12 00:00:00.000 | [(crwd.lbracket,'dwrc',7.62),(b01.13,'8',crwd.lbracket),(dwrc.2,'45',b02.2)37crwdlbracketdwrc1266b03226] |
...
| ----------------------- | --------------------------------------------------------------------------------------------------------- |
| 2022-01-12 00:00:00.000 | [(crwd.lbracket,'dwrc',2.56),(b06.3,'10',crwd.lbracket),(dwrc.7,'68',b07.10)8crwdlbracketdwrc1024b081536] |
...
| 时间                      | cid    | license | gas_percent | speed_kmh |
| ----------------------- | ------ | ------- | ----------- | --------- |
