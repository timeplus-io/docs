...
_Timeplus Core Engine (Proton v1.5.10):_
...
_Timeplus Core Engine (Proton v1.5.9):_
...
- A new advanced setting is available to control the speed of historical data backfill with a certain column. 。 `select * from test_stream where _tp_time > earliest_timestamp() settings replay_speed=1, replay_time_column='time_col'`.
