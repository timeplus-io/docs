...
Timeplus是一个简单、强大且经济的流处理平台。 It's available in different ways:

- [Timeplus Core](proton), codename Proton, is open-sourced under Apache 2.0 License. It is a fast and lightweight streaming SQL engine, powered by ClickHouse.
- [Timeplus Cloud](timeplus-cloud) is a fully-managed unified platform streaming and historical data processing.
- [Timeplus Enterprise](timeplus-enterprise) is self-managed and easy to deploy.
  Runs and scales everywhere, from edge to your data center.
